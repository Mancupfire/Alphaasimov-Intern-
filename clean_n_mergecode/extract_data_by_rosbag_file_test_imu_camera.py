...
class LogData():
    ...
    def imageCallback(self, msg):
        ...
        try:
            ...
            # cv2.imwrite("camera_23.jpg", self.cv_image)
                ...
                try:
                    ...
                    if self.img_callback_flag == True:
                        ...
                        if self.linear_vel > self.lin_vel_limit[0] and self.linear_vel < self.lin_vel_limit[1]:
                            ...
                            # print(fix_path)
                            # write to file CSV
                            writer.writerow([fullNameImage, self.angular_vel, self.linear_vel, self.dir_high_cmd, self.gps_msg.latitude, self.gps_msg.longitude, self.gps_error, self.yaw,
...
if __name__ == '__main__':
    ...
    a = LogData('front', '/front', '/home/asimovsimpc/share-work/extracted_data/test')
