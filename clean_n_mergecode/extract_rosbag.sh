...
DIR="/media/asimovsimpc/bulldog/aa-data/rosbag_scenario/phenikaa/4.1/*"
...
do
    ...
    /home/asimovsimpc/share-work/process_data/extract_data_by_scenario_v3.py --bag $i --rate $rate --fps $fps &
    sleep 1
...
DIR="/media/asimovsimpc/bulldog/aa-data/rosbag_scenario/phenikaa/4.2/*"
...
DIR="/media/asimovsimpc/bulldog/aa-data/rosbag_scenario/phenikaa/4.3/*"
