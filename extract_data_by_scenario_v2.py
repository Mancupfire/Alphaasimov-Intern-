...
args = parser.parse_args()extract_data_by_rosbag_file.py
...
if __name__ == '__main__':
    ...
    a = LogData('front', '/zed2i/zed_node/rgb/image_rect_color/compressed', '/share-work/extracted_data/rosbag_scenario')
    a.main()