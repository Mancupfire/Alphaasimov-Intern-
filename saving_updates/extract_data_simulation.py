                ...
                try:
                    ...
                    if self.img_callback_flag == True:
                        ...
                        if self.linear_vel > self.lin_vel_limit[0] and self.linear_vel < self.lin_vel_limit[1]:
                            ...
                            # write to file CSV
                            writer.writerow([fullNameImage, self.angular_vel_feedback, self.linear_vel_feedback, self.dir_high_cmd, self.gps_msg.latitude, self.gps_msg.longitude, self.gps_error, self.yaw, self.imu_msg.orientation.x, self.imu_msg.orientation.y, self.imu_msg.orientation.z, self.imu_msg.orientation.w,
